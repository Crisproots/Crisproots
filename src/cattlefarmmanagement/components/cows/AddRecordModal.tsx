...
import { X, HeartPulse, Activity, Baby, Syringe, ClipboardList, Droplet } from 'lucide-react'; // Added icons
      ...
      <div className="relative bg-white rounded-xl shadow-2xl p-6 w-full max-w-md border border-gray-100 dark:bg-gray-800 dark:border-gray-700"> {/* Themed modal card */}
        <div className="flex justify-between items-center mb-6">
          <h3 className="text-xl font-semibold text-gray-800 dark:text-white flex items-center">
            {type === 'health' ? (
              <>
                <Activity className="h-6 w-6 mr-2 text-green-600" /> Add Health Record
              </>
            ) : (
              <>
