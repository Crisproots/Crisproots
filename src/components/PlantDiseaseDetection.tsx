...
const PlantDiseaseDetection: React.FC = () => {
  ...
  const handleDrop = useCallback((e: React.DragEvent) => {
    ...
    const mockResult: AnalysisResult = {
      ...
      treatments: [
        ...
        },
        {
          ...
          precautions: ["Test on small area first", "Avoid direct sunlight"]
        },
        {
          id: "trichoderma",
          type: "biological",
      ...
      prevention: [
        ...
        },
        {
          ...
          description: "Use certified disease-resistant cultivars",
          effectiveness: 90,
          implementation: "Choose varieties with late blight resistance genes",
          cost: "medium"
        },
        {
          category: "cultural",
    ...
    setIsAnalyzing(false);
    setActiveTab('analysis');
  }, [analysisResult, setAnalysisHistory]);
